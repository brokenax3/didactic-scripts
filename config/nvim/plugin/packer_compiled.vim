...
_G.packer_plugins = {
  ...
  ["vim-pandoc"] = {
    loaded = true,
    path = "/home/mark/.local/share/nvim/site/pack/packer/start/vim-pandoc"
  },
  ["vim-pandoc-syntax"] = {
    loaded = true,
    path = "/home/mark/.local/share/nvim/site/pack/packer/start/vim-pandoc-syntax"
  },
  ["vim-repeat"] = {
    loaded = true,
  ...
  vimtex = {
    loaded = true,
    path = "/home/mark/.local/share/nvim/site/pack/packer/start/vimtex"
  }
}
