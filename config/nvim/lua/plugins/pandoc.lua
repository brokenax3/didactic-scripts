...
vim.g['pandoc#folding#fdc'] = false
vim.g['pandoc#syntax#codeblocks#embeds#langs'] = { 'c', 'asm', 'bash=sh', 'python', 'java', 'kotlin' }
vim.g['pandoc#hypertext#create_if_no_alternates_exists'] = true
vim.g['pandoc#folding#fold_fenced_codeblocks'] = true
